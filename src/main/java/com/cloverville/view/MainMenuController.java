...
public class MainMenuController {
    ...
    private void openResidents() {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/com/cloverville/fxml/ResidentView.fxml"));
    ...
    private void openGreenActions() {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/com/cloverville/fxml/GreenActionView.fxml"));
            Parent root = loader.load();
    ...
    private void openCommunal() {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/com/cloverville/fxml/CommunalView.fxml"));
            Parent root = loader.load();
    ...
    private void openTrades() {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/com/cloverville/fxml/TradeView.fxml"));
            Parent root = loader.load();
