...
import com.cloverville.model.Resident;
import com.cloverville.model.Trade;
...
public class TradeController {
    ...
    private void openEditDialog(Trade trade) {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/com/cloverville/fxml/TradeEditDialog.fxml"));
