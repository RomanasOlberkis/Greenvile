package com.cloverville.view;

import com.cloverville.model.CommunalGoal;
import com.cloverville.model.CommunalTask;
import com.cloverville.viewmodel.*;
...
public class CommunalController {
    ...
    private void onOpenDefaultTasks() {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/com/cloverville/fxml/DefaultTasksView.fxml"));
    ...
    private void openGoalEditDialog(CommunalGoal goal) {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/com/cloverville/fxml/CommunalGoalEditDialog.fxml"));
            Parent root = loader.load();
    ...
    private void openTaskEditDialog(int goalId, CommunalTask task) {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/com/cloverville/fxml/CommunalTaskEditDialog.fxml"));
            Parent root = loader.load();
